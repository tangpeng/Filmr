...
public class Config {
    ...
    public static final String TRIM_FILE_PATH = VIDEO_STORAGE_DIR +(int) ((Math.random() * 9 + 1) * 10000)+ "trimmed.mp4";
    ...
    public static final String rangk = VIDEO_STORAGE_DIR + "divide_composed.mp4";
